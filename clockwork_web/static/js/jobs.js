...
function populate_table(response_contents) {
    ...
    */
    ...
    [].forEach.call(response_contents, function(D_job) {
        ...
        td = document.createElement('td'); td.innerHTML = "<a href=\"/users/one?username="+retrieve_username_from_email(D_job["cw"]["mila_email_username"])+"\">"+retrieve_username_from_email(D_job["cw"]["mila_email_username"])+"</a>"; tr.appendChild(td); // TODO : add href for meaningful people pertaining to single user ?
