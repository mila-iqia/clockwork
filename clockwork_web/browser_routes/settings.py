...
def route_index():
    ...
    """
    logging.info(f"clockwork browser route: /settings - current_user={current_user.mila_email_username}")
...
def route_key():
    ...
    """
    logging.info(f"clockwork browser route: /settings/new_key - current_user={current_user.mila_email_username}")
...
def route_update_key():
    ...
    """
    logging.info(f"clockwork browser route: /settings/new_update_key - current_user={current_user.mila_email_username}")
...
def route_set_nbr_items_per_page():
    ...
    .. :quickref: set the number of items to display per page in the current
                  user's settings
    """
    logging.info(f"clockwork browser route: /settings/web/nbr_items_per_page/set - current_user={current_user.mila_email_username}")
...
def route_set_dark_mode():
    ...
    """
    logging.info(f"clockwork browser route: /settings/web/dark_mode/set - current_user={current_user.mila_email_username}")
...
def route_unset_dark_mode():
    ...
    """
    logging.info(f"clockwork browser route: /settings/web/dark_mode/unset - current_user={current_user.mila_email_username}")
...
def route_set_column_display():
    ...
    """
    logging.info(f"clockwork browser route: /settings/web/column/set - current_user={current_user.mila_email_username}")
...
def route_unset_column_display():
    ...
    .. :quickref: enable the display of a job element on the dashboard or on the jobs list
    """
    logging.info(f"clockwork browser route: /settings/web/column/unset - current_user={current_user.mila_email_username}")
...
def route_set_language():
    ...
    """
    logging.info(f"clockwork browser route: /settings/web/language/set - current_user={current_user.mila_email_username}")
...
def route_set_date_format():
    ...
    """
    logging.info(f"clockwork browser route: /settings/web/date_format/set - current_user={current_user.mila_email_username}")
...
def route_set_time_format():
    ...
    """
    logging.info(f"clockwork browser route: /settings/web/time_format/set - current_user={current_user.mila_email_username}")
