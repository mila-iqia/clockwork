...
def route_index():
    ...
    """
    logging.info(f"clockwork browser route: /jobs/ - current_user={current_user.mila_email_username}")
...
def route_search():
    ...
    """
    logging.info(f"clockwork browser route: /jobs/search - current_user={current_user.mila_email_username}")
...
def route_one():
    ...
    """
    logging.info(f"clockwork browser route: /jobs/one - current_user={current_user.mila_email_username}")
...
def route_interactive():
    ...
    """
    logging.info(f"clockwork browser route: /jobs/interactive - current_user={current_user.mila_email_username}")
