...
def test_set_web_setting_with_wrong_setting_key(app, client, fake_data):
    """
...
def test_set_web_setting_incorrect_value_for_existing_setting(
    app, client, known_user, fake_data, setting_key, setting_value
):
    """
...
def test_set_web_setting_set_nbr_items_per_page(app, client, known_user, value):
    """
...
def test_set_items_per_page_set_negative_number(app, client, known_user, value):
    """
...
def test_set_items_per_page_with_incorrect_value_type(app, client, fake_data, value):
    """
...
def test_set_items_per_page_set_positive_number(app, client, known_user, value):
    """
...
def test_set_date_format_with_incorrect_value_type(
    app, client, known_user, fake_data, incorrect_date_format
):
    """
...
def test_set_date_format_success(app, client, known_user, valid_date_format):
    """
...
def test_set_time_format_with_incorrect_value_type(
    app, client, known_user, fake_data, incorrect_time_format
):
    """
...
def test_set_time_format_success(app, client, known_user, valid_time_format):
    """
...
def test_enable_column_display_bad_request(
    app, client, known_user, fake_data, page_name, column_name
):
    """
...
def test_get_nbr_items_per_page_known_user(app, client, known_user):
    """
